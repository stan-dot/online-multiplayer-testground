...
quizMode(command){
  ...
  var object = () => {
    return sessionTabs.scrolls[0].createNewOic(command[1], myLocation.arrayLocation);
  }
  ...
  var relation = () => {
    ...
    return sessionTabs.scrolls[0].createNewRelation(command[1], command[2], command[3]);
  }

  var args = {
    "current":getCurrent,"pwd":getCurrent,"location": getCurrent, "cu": getCurrent,
    "exit": quit, "quit":quit, "q":quit,
    "help": err, "h": err,
    "yes": yes, "w":yes, "y":yes,
    "no": no, "s":no, "n":no,
    "both": both, "a": both, "b": both,
    "neither": neither, "d": neither, "u": neither,
    "o": object,"object": object,"obj":object,
    "r": relation,"relation": relation,"rel": relation,
  }
